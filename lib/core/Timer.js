function Timer(obj_ref, type, update_interval) {
    ...
    if (type == "deterministic") {
        ...
        this.accured_time = 0;
        this.tick = Timer.prototype.tickDeterministic;
...
Timer.prototype.tickSimple = function() {
    var self = this,
        target = this.target,
        tick = function() {
            if(self.running) {
